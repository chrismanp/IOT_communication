...
def frameprocessing(frame, tracker, label):
...
if __name__ == "__main__":
	white_output = 'object_tracking_example2.mp4'
	clip1 = VideoFileClip("object_tracking_example.mp4");
	...
	white_clip = clip1.fl_image(lambda x: frameprocessing(x, tracker, label))
