...
def s_object_detection(s, frame):
	...
	label = "{}: {:.2f}%".format(CLASSES[int(bbox_label[4])],
				bbox_label[5] * 100)
	print ("done array")
...
def frameprocessing(frame, prevframe, tracker, label, s):
...
if __name__ == "__main__":
	white_output = 'chaplin2.mp4'
	clip1 = VideoFileClip("chaplin.mp4");
	...
	white_clip = clip1.fl_image(lambda x: frameprocessing(x, prevframe, tracker, label, s))
